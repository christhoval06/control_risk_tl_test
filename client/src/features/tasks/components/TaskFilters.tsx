...
function TaskFiltersComponent({ query, onChange }: Props) {
  ...
  return (
    <div className="grid gap-3 border-y border-slate-200 bg-slate-50/70 py-3 dark:border-slate-800 dark:bg-slate-950/40 md:grid-cols-[minmax(0,1fr)_170px_170px_96px] md:items-end">
      <div>
        <Label htmlFor="search">Search</Label>
        <Input
          id="search"
          placeholder="Search tasks, owners, or controls"
          value={query.search ?? ''}
      ...
      <div>
        ...
        <Select value={query.status || 'all'} onValueChange={changeStatus}>
      ...
      <div>
        ...
        <Select value={query.sortBy ?? 'dueDate'} onValueChange={changeSort}>
