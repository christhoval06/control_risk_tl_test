...
export const inputVariants = cva(
  'flex w-full rounded-md border bg-white px-3 text-sm text-slate-950 shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-mint/20 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-slate-950 dark:text-slate-100 dark:placeholder:text-slate-500',
  {
    variants: {
      variant: {
        default: 'border-slate-300 focus-visible:border-mint dark:border-slate-700',
